        ...
        <div className="w-full space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex gap-8 border-b border-gray-200 dark:border-slate-700/50 text-sm font-medium text-gray-400 pb-px">
                {['Equipe', 'Clientes', 'Fornecedores', 'Passageiros'].map((tab, i) => (
                    <button key={tab} className={`pb-3 relative cursor-pointer ${i === 0 ? 'text-[#19727d] font-bold' : 'hover:text-gray-600 dark:hover:text-gray-300'}`}>
                        {tab}
                        {i === 0 && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-[#19727d]" />}
                    </button>
                ))}
            </div>
                        ...
                        {isAdmin && (
                            <>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 bg-[#19727d] text-white rounded-xl text-xs font-bold hover:bg-[#145d66] shadow-lg shadow-[#19727d]/20 shadow-[#19727d]/20 cursor-pointer transition-all"
                                >
                                ...
                                <tr key={member.id} className="group hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-colors">
                                    <td className="px-4 py-4 text-sm font-bold text-gray-900 dark:text-gray-200">
                                        <div className="flex items-center gap-3">
                                            {member.avatar_url ? (
                                                ...
                                                <div className="w-8 h-8 rounded-full bg-[#19727d]/10 dark:bg-[#19727d]/20 text-[#19727d] dark:text-[#19727d] flex items-center justify-center text-xs font-bold">
                                    ...
                                    <td className="px-4 py-4">
                                        <button
                                            ...
                                            className="px-3 py-1 bg-gray-100 dark:bg-slate-800 hover:bg-[#19727d]/10 dark:hover:bg-[#19727d]/10 hover:text-[#19727d] dark:hover:text-[#19727d] rounded-full text-[10px] font-bold text-gray-500 dark:text-gray-400 cursor-pointer transition-colors"
                                        >
                                    ...
                                    <td className="px-4 py-4">
                                        <div className="flex flex-col items-center gap-1">
                                            <span className="flex items-center gap-1 px-3 py-1 bg-[#19727d] text-white text-[10px] font-bold rounded-full uppercase">
                                        ...
                                        {isAdmin && (
                                            <div className="flex justify-end gap-2">
                                                <button 
                                                    ...
                                                    className="p-2 hover:bg-[#19727d]/10 dark:hover:bg-[#19727d]/10 text-gray-400 dark:text-gray-500 hover:text-[#19727d] dark:hover:text-[#19727d] rounded-lg transition-colors cursor-pointer"
                                                >
            ...
            <div className="bg-white dark:bg-[#1e293b] rounded-3xl border border-gray-100 dark:border-slate-700/50 shadow-sm p-8 min-h-[500px]">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 bg-[#19727d] text-white rounded-xl text-xs font-bold hover:bg-[#145d66] cursor-pointer">
                ...
                <div className="w-72 bg-gray-50/50 dark:bg-slate-800/20 rounded-2xl border border-gray-100 dark:border-slate-700/50 overflow-hidden">
                    <div className="p-4 border-b border-gray-100 dark:border-slate-700/50 flex items-center justify-between bg-white dark:bg-slate-800/50">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="w-8 h-8 bg-[#19727d]/10 dark:bg-[#19727d]/20 rounded-full flex items-center justify-center text-[#19727d] dark:text-[#19727d] text-[10px] font-bold">CA</div>
                            <div>
                    ...
                    <button className="w-full p-4 border-t border-gray-100 dark:border-slate-700/50 text-xs font-bold text-gray-400 dark:text-gray-500 hover:text-[#19727d] dark:hover:text-[#19727d] flex items-center gap-2 transition-colors cursor-pointer bg-white dark:bg-slate-800/50">
                    ...
                    <div className="bg-white dark:bg-[#1e293b] w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in duration-300 border border-gray-100 dark:border-slate-700/50">
                        <div className="p-8 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-2 flex-1">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-3 bg-gray-50 dark:bg-slate-900 border border-gray-100 dark:border-slate-700 rounded-xl text-sm font-medium outline-none focus:ring-2 focus:ring-[#19727d]/20 text-gray-900 dark:text-white"
                                    />
                                </div>
                                <InputField 
                                    label="Data Nasc." 
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Info
                                            onClick={() => setIsPermissionsModalOpen(true)}
                                            className="w-4 h-4 text-[#19727d] cursor-pointer hover:text-[#145d66] transition-colors"
                                        />
                                    </div>
                                    <select
                                        value={formData.role}
                                        ...
                                        className="w-full p-3 bg-gray-50 dark:bg-slate-900 border border-gray-100 dark:border-slate-700 rounded-xl text-sm font-medium focus:ring-2 focus:ring-[#19727d]/20 outline-none cursor-pointer text-gray-900 dark:text-white"
                                    >
                            ...
                            <div className="flex justify-end gap-3 pt-6 border-t border-gray-100 dark:border-slate-700/50">
                                ...
                                <button onClick={handleSaveMember} className="px-8 py-2.5 bg-[#19727d] text-white rounded-xl text-sm font-bold hover:bg-[#145d66] shadow-lg shadow-[#19727d]/20 shadow-[#19727d]/20 cursor-pointer transition-all">Salvar</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gray-50/50 dark:bg-slate-800/50 p-6 rounded-3xl border border-gray-100 dark:border-slate-700/50 space-y-4">
                                ...
                                <div className="flex gap-2">
                                    <span className="px-4 py-1.5 bg-[#19727d]/10 dark:bg-[#19727d]/20 text-[#19727d] dark:text-[#19727d] text-[10px] font-bold rounded-full border border-[#19727d]/20">Financeiro</span>
                                    <span className="px-4 py-1.5 bg-[#19727d]/10 dark:bg-[#19727d]/20 text-[#19727d] dark:text-[#19727d] text-[10px] font-bold rounded-full border border-[#19727d]/20">Notas Fiscais</span>
                                </div>
                            </div>
                            <div className="flex gap-3 pt-2">
                                ...
                                <button 
                                    ...
                                    className="flex-1 py-4 bg-[#19727d] text-white text-sm font-bold rounded-2xl hover:bg-[#145d66] shadow-lg shadow-[#19727d]/20 shadow-[#19727d]/20 transition-all cursor-pointer"
                                >
                                    Enviar Convite
                                </button>
                            </div>
                    ...
                    <div className="bg-[#2D333B] w-full max-w-5xl rounded-xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300 border border-white/5">
                        ...
                        <div className="p-4 bg-[#373E47] flex justify-end border-t border-white/5">
                            <button
                                ...
                                className="px-8 py-2 bg-[#19727d] text-white font-bold rounded-lg hover:bg-[#145d66] cursor-pointer transition-all shadow-lg shadow-[#19727d]/50"
                            >
                                Fechar
                            </button>
                        </div>
...
function PermissionGroupHeader({ title }: { title: string }) {
    return (
        <tr className="bg-[#1C2128]">
            <td colSpan={6} className="p-3 text-[#19727d] font-black flex items-center gap-2">
